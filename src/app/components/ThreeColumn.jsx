...
export default function ThreeColumn() {
  ...
  return (
    <div ref={firstSlideRef} className="inner h-full flex items-center">
      <div className="max-w-full">
        <div className="flex justify-evenly h-full items-start md:flex-nowrap flex-wrap md:py-0 py-10">
